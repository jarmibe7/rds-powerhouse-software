...
## Software Structure
* src/finger_motor_control.cpp - ROS2 wrapper for getting motor commands from desired joint torques.
* src/finger_pd_control.cpp - ROS2 wrapper for simple joint position PD controller.
* scripts/finger_target_gui.py - GUI for setting desired joint positions.
* scripts/finger_torque_gui.py - GUI for setting desired joint torques.